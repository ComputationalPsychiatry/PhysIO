function [convHRV, hr] = physio_create_hrv_regressor(ons_secs, sqpar )
% computes cardiac response function regressor and heart rate after
% running physio_main_create_regressors
%
%    [convHRV, hr] = physio_create_hrv_regressor(ons_secs, sqpar )
%
% Reference:
...
%       spulse_per_vol  See also physio_get_sample_points
%   sqpar.
%       onset_slice
% OUT
...
hr = physio_hr(ons_secs.cpulse, sample_points);
