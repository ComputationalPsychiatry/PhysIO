function [c, r, t, cpulse] = physio_read_physlogfiles_philips(logfile, cardiac_modality)
...
% or pulse oximetry)
%
%   [cpulse, rpulse, t, c] = physio_read_physlogfiles_philips(logfile, vendor, cardiac_modality)
%
% IN
